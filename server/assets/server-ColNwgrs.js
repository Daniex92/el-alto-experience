...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BLLCHbNN.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DU45hM1S.js"),
    import("./start-DduS-32N.js"),
...
var ROUTER_BASEPATH = "el-alto-experience";
var SERVER_FN_BASE = "/el-alto-experience/_serverFn/";
